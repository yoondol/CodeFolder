...
def load_latest_country_data(): 
    ...
    with open('owid-covid-data.csv', 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            # 모든 데이터의 정보를 확인하고 싶을 경우 주석 해제
            # must_fields = ['total_cases', 'new_cases', 'total_deaths', 'new_deaths',
            ...
            # 비어있으면 건너뛰기
            # if any(not row[field] for field in must_fields):
            #     continue
                
            # 날짜를 datetime 스타일 객체로 변환
