...
Smart manufacturing is changing manufacturing from a production setting centered primarily on physical equipment and isolated processes into a connected operational system built on continuous data flows \cite{song2025smart,tao2018datadriven}. Across the factory, sensing, communication, computation, and decision making are becoming increasingly integrated through technologies such as the Internet of Things (IoT), cyber--physical systems (CPS), artificial intelligence and machine learning (AI/ML), real-time monitoring, predictive maintenance, and digital twins \cite{tao2017digital,ding2019digital,nguyen2025aidriven}. Manufacturing systems should therefore be understood not only as physical production arrangements, but also as data-mediated operational systems \cite{cerquitelli2021manufacturing}.

In smart manufacturing, data no longer function merely as records of what has already happened. They have become a core operational resource that supports visibility, traceability, quality control, maintenance, and data-driven decision making \cite{ren2019bigdata,tao2018datadriven}. As a result, the practical progress of smart manufacturing depends increasingly on whether operational data can be captured, interpreted, and reused in a stable and sustained way \cite{bernstein2018contextualising}.
...
To answer these questions, the study proceeds in four steps. It first establishes a general lifecycle model of smart manufacturing data pipelines as an analytical reference. It then analyzes how recurrent constraints documented in prior SME research act across that lifecycle and derives six operational risks that undermine practical viability. On that basis, it formalizes the Operational Data Foundation Framework by translating those risks into core requirements, design principles, and operational invariants. Finally, it instantiates the framework through actual field implementation in a real SME manufacturing setting and examines its practical value through requirement-based evidence and representative field observations.
